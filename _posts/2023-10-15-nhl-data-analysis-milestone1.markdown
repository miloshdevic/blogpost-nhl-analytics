...
{% include image_full.html imageurl="{{ site.baseurl }}/images/milestone1/download_step1.png" caption="setting up the environment" %}
<!-- ![setting up the environment]({{ site.baseurl }}/images/milestone1/download_step1.png) -->
